...
System.out.print(request.getParameter("pidx"));
...
<body>
	<div>
		...
		<div id="container" style="text-align: center;">
			...
			<form name="fileForm" method="post" action="boardwritereplyproc.jsp" accept-charset="utf-8">
				...
				<div style="text-align: center;">
					<input type="hidden" value="recipe" name="type">
					<input type="hidden" value="<%=request.getParameter("pidx") %>" name="pidx">
