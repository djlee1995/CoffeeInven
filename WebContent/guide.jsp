...
List<BoardDTO> boardList = bDao.selectBoardList("guide");
%>
	...
	<div>
		...
		<div>
			...
			<div style="display: inline-block; width: 75%; vertical-align: top;">
				<div style="text-align: right;">
					<input type="button" value="글쓰기" onclick="location.href='guidewrite.jsp'">
				</div>
				...
				<div style="">
					...
					<div>
							...
							<span style="padding: 10px; width: 50%; display: inline-block;"><a href="./guidedetail.jsp?pidx=<%=b.getPidx()%>"><%=b.getTitle() %></a></span>
							...
							<span style="padding: 10px; width: 10%; display: inline-block;"><input type="button" value="삭제" onclick="location.href = './boarddelete.jsp?pidx=<%=b.getPidx()%>&type=guide'"></span>					
					</div>				
					<%} %>
				</div>	        
