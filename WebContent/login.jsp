...
<body>
	<div>
		...
		<div>
			<form action="loginproc.jsp" method="post" name="joinFrm" accept-charset="utf-8">
				<div id="container" style="text-align: center;">
					...
					<div id="content">
						...
						<input type="button" title="로그인" alt="로그인" value="로그인" class="btn_login" id="log.login" onclick="checkJoinfield()">
						<!-- 가입하기 -->
						<div id="join_con03">
