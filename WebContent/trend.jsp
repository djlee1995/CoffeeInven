...
List<BoardDTO> boardList = bDao.selectBoardList("trend");
%>
		...
		<div>
			<div style="display: inline-block; width: 20%; ">
				<ul class="nav">
					...
					<li style="background-color: #D5D5D5; "><a href="./trend.jsp">트렌드</a></li>
			...
			<div style="display: inline-block; width: 75%; vertical-align: top;">
				<div style="text-align: right;">
					<input type="button" value="글쓰기" onclick="location.href='trendwrite.jsp'">
				</div>
				...
				<div style="">
					...
					<div>
							...
							<span style="padding: 10px; width: 50%; display: inline-block;"><a href="./trenddetail.jsp?pidx=<%=b.getPidx()%>"><%=b.getTitle() %></a></span>
							...
							<span style="padding: 10px; width: 10%; display: inline-block;"><input type="button" value="삭제" onclick="location.href = './boarddelete.jsp?pidx=<%=b.getPidx()%>&type=trend'"></span>					
					</div>				
					<%} %>
				</div>	        
